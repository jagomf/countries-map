...
export class CountriesMapModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "18.2.13", ngImport: i0, type: CountriesMapModule, declarations: [CountriesMapBaseComponent, CountriesMapComponent], imports: [CommonModule], exports: [CountriesMapComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: CountriesMapModule, imports: [CommonModule] }); }
}
